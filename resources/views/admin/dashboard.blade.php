    ...
    <section class="m-2">
        ...
        <div class="table-container">
            ...
            <table class="table table-striped table-bordered ">
                ...
                @empty
                    <tr>
                        <td colspan="6" class="text-center">Tidan ada data pesanan baru</td>
                    </tr>
                @endforelse
        ...
        <div class="table-container">
            ...
            <table class="table table-striped table-bordered ">
                ...
                @empty
                    <tr>
                        <td colspan="6" class="text-center">Tidan ada data pesanan untuk dikirim</td>
                    </tr>
                @endforelse
            </table>
